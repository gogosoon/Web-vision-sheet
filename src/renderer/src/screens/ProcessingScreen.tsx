...
const ProcessingScreen: React.FC = () => {
  ...
  const calculateProgress = () => {
    ...
    if (currentStep === 'error')
      return processingStats.totalRows > 0
        ? Math.min(99, Math.round((currentRowIndex / totalRows) * 100))
        : 0 // Show progress up to error point
  ...
  const formatStepName = (step: ProcessingStats['currentStep']) => {
    switch (step) {
      ...
      case 'taking-screenshots':
        return 'Taking Screenshots'
      case 'processing-screenshots':
          ...
          <div className="text-center mb-6">
            ...
            {processingStats.currentStep !== 'completed' &&
              processingStats.currentStep !== 'error' && (
                <p
                  ...
                  title={processingStats.currentLogMessage}
                >
            ...
            {processingStats.currentStep === 'error' && (
              <p
                ...
                title={processingStats.error || 'An unknown error occurred'}
              >
